...
function Recipes(props) {
  return __jsx("div", null, props.recipes && props.recipes.map(recipe => __jsx(_Recipe__WEBPACK_IMPORTED_MODULE_1__["default"], {
    key: recipe._id,
    recipe: recipe
...
function Index(props) {
  return __jsx(_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_1___default.a, {
    ...
    component: "h1",
    gutterBottom: true
  }, __jsx(_components_Recipes__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
Index.getInitialProps = async ({
  ...
  const res = await isomorphic_fetch__WEBPACK_IMPORTED_MODULE_5___default()(`${baseURL}/api/recipes`);
  return {
...
module.exports = __webpack_require__(/*! /home/ubuntu/recipesharer/src/pages/index.js */"./pages/index.js");
